...
import eTriangleType from './eTriangleType';
    ...
    getTriangles (colorMap) {
        ...
        switch (triType) {
            case eTriangleType.scalene: {
                ...
                let sub1 = new Triangle(sortedVertices[0], sortedVertices[1], pMid);
                let sub2 = new Triangle(pMid, sortedVertices[1], sortedVertices[2]);
                ret = ret.concat(sub1.getTriangles(colorMap));
                ret = ret.concat(sub2.getTriangles(colorMap));
            } break;
