...
ColorTriangle.prototype = Object();
ColorTriangle.prototype.constructor = function (v1, v2, v3, color) {
    this.vertices = [v1, v2, v3];
    this.color = color;
};

ColorTriangle.prototype.draw = function () {
...
ColorTriangle.prototype.getInnerValue = function (x, y) {
    let totalW = 0.0;
    let totalValue = 0.0;
